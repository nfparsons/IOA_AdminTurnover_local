...
## write data
write_dta(data, here("data", "adturnr.dta"))
...
```{r}
#| label: recode as dummy variables for factor analysis
data |> 
  mutate(across(starts_with("q19_"), ~case_when(. == 1 ~ "Very disatisfied", 
                                                 . == 2 ~ "Disatisfied", 
                                                 . == 3 ~ "Neutral", 
                                                 . == 4 ~ "Satisfied", 
                                                 . == 5 ~ "Very satisfied")), 
         across(c(starts_with("q20_"), starts_with("q26_")), ~case_when(. == 1 ~ "Strongly disagree", 
                                                . == 2 ~ "Disagree", 
                                                . == 3 ~ "Neutral", 
                                                . == 4 ~ "Agree", 
                                                . == 5 ~ "Strongly agree"))
  ) |> 
  dummy_cols(select_columns = c("q19_1", "q19_2", "q19_3", "q19_4", "q19_5", 
...
## define the model
q20.path <- '
s1 = ~ q20_1 + q20_3 + q20_6 + q20_7 + q20_9 + q20_12 + q20_13
s2 = ~ q20_2 + q20_4 + q20_8
s3 = ~ q20_5 + q20_10
s4 = ~ q20_11 + q20_14 + q20_15
'

## fit the model
q20.model <- cfa(q20.path, data = data)
